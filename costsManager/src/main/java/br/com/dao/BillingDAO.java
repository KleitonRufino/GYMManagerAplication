...
public class BillingDAO {
	public void save(Billing billing, Long idColaborador) {
		Connection conexao = Conexao.getConnection();
		PreparedStatement insereSt = null;
		String sql = "insert into conta(datavencimento, descricao, statuspagamento, tipoconta, valorconta, responsavel_id) values (?,?,?,?,?,?)";
		try {
			...
			insereSt.setLong(6, idColaborador);
